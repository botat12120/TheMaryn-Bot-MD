...
**/
    ...
    const htextos = `${text ? text : '> https://whatsapp.com/channel/0029VaUpcIqJuyA4hiyNYR1K*'}`;
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://whatsapp.com/channel/0029VaUpcIqJuyA4hiyNYR1K'}}}}}, {});
    }
  }
};
handler.command = /^(مخفي|منشن-مخفي|جماعي-مخفي)$/i;
handler.group = true;
handler.admin = true;
